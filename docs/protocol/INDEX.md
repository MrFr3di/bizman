...
- `knowledge/actions/catalog.json` — 8 normalized observed write-action families.
...
- `knowledge/forms/parameters.json` — 62 cross-action form parameters with sample values.
- `knowledge/http/routes/index.json` — 732 normalized routes referenced by captured HTML/JavaScript.
